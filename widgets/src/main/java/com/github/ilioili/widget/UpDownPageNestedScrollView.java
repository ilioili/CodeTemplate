...
public class UpDownPageNestedScrollView extends FrameLayout implements NestedScrollingParent,
    ...
    public interface OnScrollChangeListener {
         ...
         */
        void onScrollChange(UpDownPageNestedScrollView v, int scrollX, int scrollY,
    ...
    public UpDownPageNestedScrollView(Context context) {
        this(context, null);
    }

    public UpDownPageNestedScrollView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public UpDownPageNestedScrollView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        super.addView(innerContainer, -1, generateDefaultLayoutParams());
    }
                ...
                public void run() {
                    if (mScroller.isFinished()) {
                        if (getScrollY() > getHeight() / 2) {
                            ...
                            invokePageSelectedListenerIfNecessary(false);
                        } else {
                            smoothScrollTo(0, 0);
                            invokePageSelectedListenerIfNecessary(true);
                        }
                    }else{
                        Toast.makeText(getContext(), "animation is not finished !", Toast.LENGTH_SHORT).show();
                    }
                }
            });
    ...
    public final void smoothScrollBy(int dx, int dy) {
        ...
        if (duration > ANIMATED_SCROLL_GAP) {
            ...
            mScroller.startScroll(getScrollX(), scrollY, 0, dy, DEFAULT_DURATION);
            ViewCompat.postInvalidateOnAnimation(this);
    ...
    private void invokePageSelectedListenerIfNecessary(final boolean isFirstPage) {
        if (null != onPageSelectedListener) {
            postDelayed(new Runnable() {
                @Override
                public void run() {
                    if (isFirstPage) {
                        onPageSelectedListener.onScrollToFirstPage();
                    } else {
                        onPageSelectedListener.onScrollToSecondPage();
                    }
                }
            }, DEFAULT_DURATION);
        }
    ...
    static class AccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public boolean performAccessibilityAction(View host, int action, Bundle arguments) {
            ...
            final UpDownPageNestedScrollView nsvHost = (UpDownPageNestedScrollView) host;
