...
public class NavigationDrawerActivity extends AppBaseActivity
    ...
    private CustomerWidgetListFragment canvasDemoListFragment = new CustomerWidgetListFragment();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportFragmentManager().beginTransaction().add(R.id.fragment_container, activityListFragment, ActivityListFragment.class.getName()).commit();
    }
...
//            String url = "mqqapi://card/show_pslcard?src_type=internal&uin=4008260035&card_type=group";
    ...
    private void switchToPlayground() {
        getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container, activityListFragment).commit();
    }
