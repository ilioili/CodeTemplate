...
import com.github.ilioili.demo.BaseWebActivity;
import com.github.ilioili.demo.R;
import com.github.ilioili.demo.provider.ActivityLabel;
import com.github.ilioili.demo.main.frame.selectfile.FileSelectDemoActivity;
import com.github.ilioili.demo.main.frame.http.HttpActivity;
import com.github.ilioili.demo.main.frame.BottomTabActivity;
import com.github.ilioili.demo.main.frame.InjectionActivity;
import com.github.ilioili.demo.main.frame.ScrollableTabActivity;
...
public class FrameListFragment extends BaseFragment implements View.OnClickListener{
    private Class[] activities = new Class[]{BaseWebActivity.class, BottomTabActivity.class, ScrollableTabActivity.class, InjectionActivity.class, HttpActivity.class, FileSelectDemoActivity.class};
    ...
    private RecyclerView.Adapter adapter = new RecyclerView.Adapter<Holder>() {
        ...
        public Holder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            view.setOnClickListener(FrameListFragment.this);
